...
export default function Module4() {
  ...
  useEffect(() => {
    ...
    if (countdown <= 0) { localStorage.setItem('module5_activeSection', '1'); navigate('/module5'); return; }
  ...
  return (
    ...
    <div className="module-container module-page module4 m4-page">
      ...
      <AnimatePresence>
        {showCompletion && (
          <CompletionScreen
            title={isTurkish ? 'Modül 4 Tamamlandı!' : 'Module 4 Complete!'}
            description={isTurkish ? 'Şifre güvenliğini başarıyla öğrendin! Dijital güvenlik modülüne geçiyoruz.' : 'You mastered password security! Moving on to digital safety.'}
            countdown={countdown}
            nextLabel={isTurkish ? "saniye sonra Modül 5'e geçiliyor..." : 'seconds until Module 5...'}
            buttonLabel={isTurkish ? "🚀 Modül 5'e Geç" : '🚀 Go to Module 5'}
            onNavigate={() => { localStorage.setItem('module5_activeSection', '1'); navigate('/module5'); }}
          />
        )}
      </AnimatePresence>
