  ...
  return (
    <div className="module-container module-page module2">
      ...
      <AnimatePresence>
        {showCompletion && (
          <CompletionScreen
            title={isTurkish ? 'Modül 2 Tamamlandı!' : 'Module 2 Complete!'}
            description={isTurkish ? 'Dijital ayak izi ve çevrimiçi gizliliği başarıyla öğrendin! Şimdi bilgisayar ağları dünyasına geçiyoruz.' : 'You mastered digital footprint and online privacy! Now moving on to computer networks.'}
            countdown={countdown}
            nextLabel={isTurkish ? "saniye sonra Modül 3'e geçiliyor..." : 'seconds until Module 3...'}
            buttonLabel={isTurkish ? "🚀 Modül 3'e Geç" : '🚀 Go to Module 3'}
