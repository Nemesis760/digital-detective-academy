  ...
  return (
    <div className="module-container module-page module3">
      ...
      <AnimatePresence>
        {showCompletion && (
          <CompletionScreen
            title={isTurkish ? 'Modül 3 Tamamlandı!' : 'Module 3 Complete!'}
            description={isTurkish ? "Bilgisayar ağları ve dijital iletişimi başarıyla tamamladın! Şimdi Modül 4'e geçiyoruz." : 'You successfully completed computer networks and digital communication! Now moving on to Module 4.'}
            countdown={countdown}
            nextLabel={isTurkish ? "saniye sonra Modül 4'e geçiliyor..." : 'seconds until Module 4...'}
            buttonLabel={isTurkish ? "🚀 Modül 4'e Geç" : '🚀 Go to Module 4'}
