  ...
  return (
    <div className="module-container module-page module5">
      ...
      <AnimatePresence>
        {showCompletion && (
          <CompletionScreen
            title={isTurkish ? 'Modül 5 Tamamlandı!' : 'Module 5 Complete!'}
            description={isTurkish ? 'Dijital güvenliği başarıyla öğrendin! Son modüle geçiyoruz.' : 'You mastered digital safety! Moving on to the final module.'}
            countdown={countdown}
            nextLabel={isTurkish ? "saniye sonra Modül 6'ya geçiliyor..." : 'seconds until Module 6...'}
            buttonLabel={isTurkish ? "🚀 Modül 6'ya Geç" : '🚀 Go to Module 6'}
            onNavigate={() => { localStorage.setItem('module6_activeSection', '1'); navigate('/module6'); }}
          />
        )}
      </AnimatePresence>
